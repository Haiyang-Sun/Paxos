...
public class PaxosPushMessage extends PaxosMessage {
	...
	public PaxosPushMessage(Proposer proposer, int slotIndex, ValueType decision) {
		super(proposer, slotIndex);
		this.proposer = proposer;
		this.decision = decision;
	}
	
	public PaxosPushMessage(Proposer proposer, int slotIndex, ValueType decision, int msgId) {
	...
	public ByteBuffer getMessageBytes(){
		...
		bytes.put(PaxosMessenger.msgType2Byte(MessageType.MSG_PROPOSER_PUSH));
